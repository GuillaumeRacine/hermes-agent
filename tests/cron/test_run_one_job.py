...
def _patch_pipeline(monkeypatch, *, success=True, output="out", final="final response",
    ...
    def fake_mark(jid, ok, err=None, delivery_error=None, delivered_hash=None):
...
def test_run_one_job_exception_marks_failure(monkeypatch):
    ...
    monkeypatch.setattr(
        s, "mark_job_run",
        lambda jid, ok, err=None, delivery_error=None, delivered_hash=None: marks.append((jid, ok)),
    )
